...
write_headers(ws, 'F')
write_headers(ws, 'I')
_____________________ HELPER FUNCTIONS _______________________
"""
...
""" Stores details about a traffic scenario such as its name, hour, 
    year, condition, and various data files."""
class Scenario:
